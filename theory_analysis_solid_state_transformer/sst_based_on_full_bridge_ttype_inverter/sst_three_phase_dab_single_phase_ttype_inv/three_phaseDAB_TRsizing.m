...
%--------------------------------------------------------------------------
V1 = 400;            % Primary RMS Voltage [V]
I1 = 275;            % Primary RMS Current [A]
I2 = 275;            % Primary RMS Current [A]
f = 4e3;             % Operating Frequency [Hz]
...
%% 3. Core Loss (P_Fe) Estimation (AM-NC-320C AMMET Nanocrystalline cut cores)
...
fprintf('Total Losses (3P - P_tot): %.2f W\n', 3*(P_Fe + P_Cu));
disp('----------------------------------------------------');
